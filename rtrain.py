...
def extend_cfg(cfg, args):
    ...
    cfg.TRAINER.MAPLE.PROMPT_DEPTH = args.prompt_depth # Max 12, minimum 0, for 1 it will act as shallow MaPLe (J=1)

    # Config for RMaPLe
    cfg.TRAINER.RMAPLE = CN()
    cfg.TRAINER.RMAPLE.N_CTX = 2  # number of context vectors
    cfg.TRAINER.RMAPLE.CTX_INIT = "a photo of a"  # initialization words
    ...
    cfg.TRAINER.RCOOP.CTX_INIT = ""  # initialization words
    cfg.TRAINER.RCOOP.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.RCOOP.CLASS_TOKEN_POSITION = "end"  # 'middle' or 'end' or 'front'
    cfg.TRAINER.RCOOP.TEM = 0.5
    cfg.TRAINER.RCOOP.ALPHA = 4
